...
class PDMScorer:
    ...
    def _calculate_ttc(self):
        ...
        # create polygons for each ego position and specific time horizon future projection
        ...
        # TTC looks ahead by `future_time_idcs`, so evaluate only valid base steps.
